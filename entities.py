...
class Entity:
    ...
    def update(self, dt):
        ...
        if self.scaled_frames:
            ...
            if self.current_time >= self.scaled_frames[self.current_frame][1]:
...
class Rogue(Entity):
    ...
    def handle_movement(self, keys, x_pos, y_pos, colliders):
        new_x_pos = x_pos
        new_y_pos = y_pos
    ...
    def heal(self, heal_amount):
        ...
        #Cap health at max
        self.health = min(self.health + heal_amount, 2000)
